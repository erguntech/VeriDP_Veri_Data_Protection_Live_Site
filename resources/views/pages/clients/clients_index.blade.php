...
@section('PageTitle', __('messages.clients.index.01'))
                ...
                <div class="card-body">
                    <div class="row p-0">
                        ...
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-success d-block">{{ __('messages.clients.index.03') }}</span>
                        ...
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-primary d-block">{{ __('messages.clients.index.04') }}</span>
                                <span class="fs-2hx fw-bold text-gray-900" data-kt-countup="true" data-kt-countup-value="{{ $activeClientCount }}">0</span>
                            </div>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-danger d-block">{{ __('messages.clients.index.05') }}</span>
                                <span class="fs-2hx fw-bold text-gray-900" data-kt-countup="true" data-kt-countup-value="{{ $passiveClientCount }}">0</span>
                            </div>
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                        ...
                        <tr class="fw-bolder fs-7 text-uppercase gy-5">
                            ...
                            <th>{{ __('messages.clients.index.datatables.01') }}</th>
                            <th>{{ __('messages.clients.index.datatables.02') }}</th>
                            <th>{{ __('messages.clients.index.datatables.03') }}</th>
                            <th>{{ __('messages.clients.index.datatables.04') }}</th>
