            ...
            <div class="card card-flush h-lg-100">
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex flex-stack">
                        <!--begin::Section-->
                        <div class="text-gray-700 fw-semibold fs-6 me-2">{{ __('messages.dashboard.clients.02.01') }}</div>
                        <!--end::Section-->
                        <!--begin::Statistics-->
                        <div class="d-flex align-items-senter">
                            <span class="text-gray-900 fw-bolder fs-6" data-kt-countup="true" data-kt-countup-value="{{ $totalEmployeeCount }}">0</span>
                        </div>
                        <!--end::Statistics-->
                    </div>
                    <!--end::Item-->
                    ...
                    <div class="d-flex flex-stack">
                        <!--begin::Section-->
                        <div class="text-gray-700 fw-semibold fs-6 me-2">{{ __('messages.dashboard.clients.02.02') }}</div>
                        <!--end::Section-->
                        <!--begin::Statistics-->
                        <div class="d-flex align-items-senter">
                            <!--begin::Number-->
                            <span class="text-gray-900 fw-bolder fs-6" data-kt-countup="true" data-kt-countup-value="{{ $totalDepartmentCount }}">0</span>
                            <!--end::Number-->
                        </div>
                        <!--end::Statistics-->
                    </div>
