...
@section('PageTitle', __('messages.inventory_data_sets.create.01'))
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">{{ __('messages.inventory_data_sets.create.02') }}</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('InventoryDataSets.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf

                        <div class="row">
                            <div class="col-12">
                                <label for="input-data_title" class="required form-label">{{ __('messages.inventory_data_sets.form.02') }}</label>
                                <input type="text" name="input-data_title" id="input-data_title" class="form-control @error('input-data_title') is-invalid error-input @enderror" placeholder="{{ __('messages.inventory_data_sets.form.02') }} {{ __('messages.forms.01') }}" maxlength="1000" value="{{ old('input-data_title') }}"/>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select @error('input-department_id') is-invalid error-input @enderror" name="input-department_id" id="input-department_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" @if (old('input-department_id') == $department->id) selected="selected" @endif>{{ $department->department_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select @error('input-inventory_category_id') is-invalid error-input @enderror" name="input-inventory_category_id" id="input-inventory_category_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    ...
                                    @foreach($inventoryCategories as $inventoryCategory)
                                        <option value="{{ $inventoryCategory->id }}" @if (old('input-inventory_category_id') == $inventoryCategory->id) selected="selected" @endif>{{ $inventoryCategory->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select @error('input-inventory_data_type_id') is-invalid error-input @enderror" name="input-inventory_data_type_id" id="input-inventory_data_type_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    ...
                                    @foreach($inventoryDataTypes as $inventoryDataType)
                                        <option value="{{ $inventoryDataType->id }}" @if (old('input-inventory_data_type_id') == $inventoryDataType->id) selected="selected" @endif>{{ $inventoryDataType->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-data_hold_reason_ids') is-invalid error-input @enderror" name="input-data_hold_reason_ids[]" id="input-data_hold_reason_ids" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="false" multiple="multiple">
                                    ...
                                    @foreach($dataHoldReasons as $dataHoldReason)
                                        <option value="{{ $dataHoldReason->id }}" @if (old('input-data_hold_reason_ids') == $dataHoldReason->id) selected="selected" @endif>{{ $dataHoldReason->content }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-related_to_id') is-invalid error-input @enderror" name="input-related_to_id" id="input-related_to_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-related_to_id') == '1' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.06.01') }}</option>
                                    <option value="2" {{ old('input-related_to_id') == '2' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.06.02') }}</option>
                                    <option value="3" {{ old('input-related_to_id') == '3' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.06.03') }}</option>
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-4">
                                ...
                                <input type="text" name="input-legal_reason" id="input-legal_reason" class="form-control @error('input-legal_reason') is-invalid error-input @enderror" placeholder="{{ __('messages.inventory_data_sets.form.07') }} {{ __('messages.forms.01') }}" maxlength="1000" value="{{ old('input-legal_reason') }}"/>
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="input-data_hold_place" id="input-data_hold_place" class="form-control @error('input-data_hold_place') is-invalid error-input @enderror" placeholder="{{ __('messages.inventory_data_sets.form.08') }} {{ __('messages.forms.01') }}" maxlength="1000" value="{{ old('input-data_hold_place') }}"/>
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="input-data_hold_time" id="input-data_hold_time" class="form-control @error('input-data_hold_time') is-invalid error-input @enderror" placeholder="{{ __('messages.inventory_data_sets.form.09') }} {{ __('messages.forms.01') }}" maxlength="1000" value="{{ old('input-data_hold_time') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <select class="form-select @error('input-data_transfer_to_id') is-invalid error-input @enderror" name="input-data_transfer_to_id" id="input-data_transfer_to_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-data_transfer_to_id') == '1' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.10.01') }}</option>
                                    <option value="2" {{ old('input-data_transfer_to_id') == '2' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.10.02') }}</option>
                                </select>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select @error('input-data_to_abroad') is-invalid error-input @enderror" name="input-data_to_abroad" id="input-data_to_abroad" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-data_to_abroad') == '1' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.11.01') }}</option>
                                    <option value="0" {{ old('input-data_to_abroad') == '0' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.11.02') }}</option>
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-kvkk_precaution_ids') is-invalid error-input @enderror" name="input-kvkk_precaution_ids[]" id="input-kvkk_precaution_ids" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="false" multiple="multiple">
                                    ...
                                    @foreach($kvkkPrecautions as $kvkkPrecaution)
                                        <option value="{{ $kvkkPrecaution->id }}" @if (old('input-kvkk_precaution_ids') == $kvkkPrecaution->id) selected="selected" @endif>{{ $kvkkPrecaution->content }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-is_active') is-invalid error-input @enderror" name="input-is_active" id="input-is_active" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-is_active') == '1' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.13.01') }}</option>
                                    <option value="0" {{ old('input-is_active') == '0' ? 'selected' : '' }}>{{ __('messages.inventory_data_sets.form.13.02') }}</option>
                                </select>
