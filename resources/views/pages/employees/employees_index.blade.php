...
@section('PageTitle', __('messages.employees.index.01'))
            ...
            <div class="card">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('Employees.Create') }}" class="btn btn-light-success btn-icon btn-sm">
                ...
                <div class="card-body">
                    <div class="row p-0">
                        ...
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-success d-block">{{ __('messages.employees.index.03') }}</span>
                                <span class="fs-2hx fw-bold text-gray-900" data-kt-countup="true" data-kt-countup-value="{{ $totalDataCount }}">0</span>
                            </div>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col">
                            <div class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2">
                                <span class="fs-4 fw-semibold text-primary d-block">{{ __('messages.employees.index.04') }}</span>
                                <span class="fs-2hx fw-bold text-gray-900" data-kt-countup="true" data-kt-countup-value="{{ $totalDepartmentCount }}">0</span>
                            </div>
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                        ...
                        <tr class="fw-bolder fs-7 text-uppercase gy-5">
                            ...
                            <th>{{ __('messages.employees.index.datatables.01') }}</th>
                            <th>{{ __('messages.employees.index.datatables.02') }}</th>
                            <th>{{ __('messages.employees.index.datatables.03') }}</th>
                            <th>{{ __('messages.employees.index.datatables.04') }}</th>
    ...
    <script type="text/javascript">
        function deleteData(btn) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "employees/"+btn.getAttribute('data-id'),
                        type: 'DELETE',
                        data: {
