...
@section('PageTitle', __('messages.gdpr_adaptation_questions.create.01'))
        ...
        <div class="col-xl-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">{{ __('messages.gdpr_adaptation_questions.create.02') }}</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('GDPRAdaptationQuestions.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <label for="input-question_content" class="required form-label">{{ __('messages.gdpr_adaptation_questions.form.01') }}</label>
                                <input type="text" name="input-question_content" id="input-question_content" class="form-control @error('input-question_content') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_adaptation_questions.form.01') }} {{ __('messages.forms.01') }}" maxlength="1000" value="{{ old('input-question_content') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-question_answer" id="input-question_answer" class="form-control @error('input-question_answer') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_adaptation_questions.form.02') }} {{ __('messages.forms.01') }}" maxlength="1000" value="{{ old('input-question_answer') }}"/>
                        ...
                        <div class="row mt-6">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-question_suggestions" id="input-question_suggestions" class="form-control @error('input-question_suggestions') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_adaptation_questions.form.04') }} {{ __('messages.forms.01') }}" maxlength="1000" value="{{ old('input-question_suggestions') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-4">
                                ...
                                <input type="text" name="input-question_score" id="input-question_score" class="form-control @error('input-question_score') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_adaptation_questions.form.05') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-question_score') }}"/>
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="input-order" id="input-order" class="form-control @error('input-order') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_adaptation_questions.form.06') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-order') }}"/>
                            ...
                            <div class="col-4">
                                ...
                                <select class="form-select @error('input-is_active') is-invalid error-input @enderror" name="input-is_active" id="input-is_active" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-is_active') == '1' ? 'selected' : '' }}>{{ __('messages.gdpr_adaptation_questions.form.07.01') }}</option>
                                    <option value="0" {{ old('input-is_active') == '0' ? 'selected' : '' }}>{{ __('messages.gdpr_adaptation_questions.form.07.02') }}</option>
                                </select>
