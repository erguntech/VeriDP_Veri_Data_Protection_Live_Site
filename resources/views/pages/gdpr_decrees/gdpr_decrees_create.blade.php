...
@section('PageTitle', __('messages.gdpr_decrees.create.01'))
        ...
        <div class="col-xl-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">{{ __('messages.gdpr_decrees.create.02') }}</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('GDPRDecrees.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <label for="input-title" class="required form-label">{{ __('messages.gdpr_decrees.form.01') }}</label>
                                <input type="text" name="input-title" id="input-title" class="form-control @error('input-title') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_decrees.form.01') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-title') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input name="input-date" id="input-date" class="form-control @error('input-date') is-invalid error-input @enderror" placeholder="{{ __('messages.forms.06') }}" value="{{ old('input-date') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <input type="text" name="input-decree_no" id="input-decree_no" class="form-control @error('input-decree_no') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_decrees.form.03') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-decree_no') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-content" id="input-content" class="form-control @error('input-content') is-invalid error-input @enderror" placeholder="{{ __('messages.gdpr_decrees.form.04') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-content') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-sector_id') is-invalid error-input @enderror" name="input-sector_id" id="input-sector_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="0" {{ old('input-sector_id') == '0' ? 'selected' : '' }}>Sağlık Sektörü</option>
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-is_active') is-invalid error-input @enderror" name="input-is_active" id="input-is_active" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-is_active') == '1' ? 'selected' : '' }}>{{ __('messages.gdpr_decrees.form.06.01') }}</option>
                                    <option value="0" {{ old('input-is_active') == '0' ? 'selected' : '' }}>{{ __('messages.gdpr_decrees.form.06.02') }}</option>
                                </select>
