...
@section('PageTitle', __('messages.gdpr_decrees.index.01'))
            ...
            <div class="card">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('GDPRDecrees.Create') }}" class="btn btn-light-success btn-icon btn-sm">
                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-hover table-rounded table-row-bordered table-row-gray-200 gy-1 gs-10" style="min-height: 100%; width: 100% !important;">
                        ...
                        <tr class="fw-bolder fs-7 text-uppercase gy-5">
                            ...
                            <th>{{ __('messages.gdpr_decrees.index.datatables.01') }}</th>
                            <th>{{ __('messages.gdpr_decrees.index.datatables.02') }}</th>
                            <th>{{ __('messages.gdpr_decrees.index.datatables.03') }}</th>
                            <th>{{ __('messages.gdpr_decrees.index.datatables.04') }}</th>
...
@section('PageCustomJS')
    <script>
        var table, dt;
        var editUrl = '{{ route("GDPRDecrees.Edit", ":id") }}';
    ...
    <script type="text/javascript">
        function deleteData(btn) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "gdprdecrees/"+btn.getAttribute('data-id'),
                        type: 'DELETE',
                        data: {
