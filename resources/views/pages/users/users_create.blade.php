...
@section('PageTitle', __('messages.users.create.01'))
        ...
        <div class="col-xl-12">
            <div class="alert alert-info d-flex align-items-center p-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span>- {{ __('messages.users.alert.02') }}</span>
                </div>
            </div>

            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">{{ __('messages.users.create.02') }}</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('Users.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <label for="input-first_name" class="required form-label">{{ __('messages.users.form.01') }}</label>
                                <input type="text" name="input-first_name" id="input-first_name" class="form-control @error('input-first_name') is-invalid error-input @enderror" placeholder="{{ __('messages.users.form.01') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-first_name') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-last_name" id="input-last_name" class="form-control @error('input-last_name') is-invalid error-input @enderror" placeholder="{{ __('messages.users.form.02') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-last_name') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <input type="email" name="input-email" id="input-email" class="form-control @error('input-email') is-invalid error-input @enderror" placeholder="{{ __('messages.users.form.03') }} {{ __('messages.forms.01') }}" maxlength="50" value="{{ old('input-email') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <select class="form-select @error('input-client_id') is-invalid error-input @enderror" name="input-client_id" id="input-client_id" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}">
                                    <option></option>
                                    <option value="0" {{ old('input-client_id') == '0' ? 'selected' : '' }}>{{ Settings::get('app_name') }}</option>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select @error('input-is_active') is-invalid error-input @enderror" name="input-is_active" id="input-is_active" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="1" {{ old('input-is_active') == '1' ? 'selected' : '' }}>{{ __('messages.users.form.05.01') }}</option>
                                    <option value="0" {{ old('input-is_active') == '0' ? 'selected' : '' }}>{{ __('messages.users.form.05.02') }}</option>
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-user_type') is-invalid error-input @enderror" name="input-user_type" id="input-user_type" data-control="select2" data-placeholder="{{ __('messages.forms.06') }}" data-hide-search="true">
                                    <option></option>
                                    <option value="0" {{ old('input-user_type') == '0' ? 'selected' : '' }}>{{ __('messages.users.form.07.01') }}</option>
                                    <option value="1" {{ old('input-user_type') == '1' ? 'selected' : '' }}>{{ __('messages.users.form.07.02') }}</option>
                                    <option value="2" {{ old('input-user_type') == '2' ? 'selected' : '' }}>{{ __('messages.users.form.07.03') }}</option>
                                    <option value="3" {{ old('input-user_type') == '3' ? 'selected' : '' }}>{{ __('messages.users.form.07.04') }}</option>
                                    <option value="4" {{ old('input-user_type') == '4' ? 'selected' : '' }}>{{ __('messages.users.form.07.05') }}</option>
                                </select>
